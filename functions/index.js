...
/*  mergeFields, the docusealFieldMap, and the actual                  */
/*  client/listing/agent data.                                         */
/*                                                                     */
/*  Field-name resolution order:                                       */
/*    1. field.docusealFieldName  (realtor-uploaded templates)         */
/*    2. template.docusealFieldMap[fieldId]                            */
/*    3. fieldId                  (last-ditch: same name in template)  */
/*                                                                     */
/*  fieldId reads either `field.fieldId` (new) or                      */
/*  `field.boldSignFieldId` (legacy data) for backward compatibility.  */
/* ------------------------------------------------------------------ */
...
/*  sequential /submissions calls per template.                        */
/* ------------------------------------------------------------------ */
...
/*                                                                     */
/*  GET /submissions/{id}. Returns a normalized status shape.          */
/* ------------------------------------------------------------------ */
...
/* ================================================================
   resendEnvelope
   ----------------------------------------------------------------
   Sends a fresh "please sign" reminder email to outstanding signers
   via POST /submissions/{id}/email.
   ================================================================ */
